   ...
   //Sort testing code
    ...
    public static void main(String[]args){
      ...
      if(Arrays.equals(start,result)){
        System.out.println("PASS Case "+name(i)+"\t array, size:"+start.length+"\t"+elapsedTime/1000.0+"sec ");
      }else{
        System.out.println("FAIL ! ERROR ! "+name(i)+" array, size:"+size+"  ERROR!");
      }
    }
    }
}
